...
\verb!\documentclass{!\textit{klasse}\verb!}!.  Ab
\verb!\begin{document}! kann der eigentliche Inhalt bis \verb!\end{document}! eingefügt werden.
...
\texttt{subcaption}    &    Teilabbildungen (siehe \LaTeX{} Beispiel)\\
...
\verb!\begin{quotation}!  &  Wie \texttt{quote} mit erster Zeile eingerückt. \\
...
\verb!\@.!     &  Setzt den \verb!.! als Satzende fest (Wichtig für Abkürzungen).
                        Mit \verb!.\@! ist \verb!.! kein Satzende. \\
...
Tabulatoren könne auf ``unsichtbaren'' Zeilen gesetzt werden mit \verb!\kill!
am Ende der Zeile. Zeilenumbruch mit \verb!\\!.
...
Um Formeln in den Fließtext zu setzen müssen sie in \texttt{\$formel\$} geschrieben werden oder in eine Umgebung wie
\verb!\begin{equation}!. In der Umgebung sind sie vom Text abgesetzt.
...
Mit einem \verb!*! nach der Umgebung wird die Nummerierung unterdrückt.
